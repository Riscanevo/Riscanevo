...
Soy Estudiante de Ingeniería de Software en la Universidad Fundación de Estudios Superiores Comfanorte (FESC), cursando actualmente 7.° semestre con un enfoque sólido en desarrollo Web Full Stack. Poseo experiencia técnica en la creación de interfaces modernas y dinámicas utilizando Angular, React, JavaScript, Tailwind CSS y Bootstrap, integradas con arquitecturas robustas en el Backend mediante Java , PHP (Laravel) y Python.
...
Habilidades en HTML, CSS, JavasCript, REACT.JS, ANGULAR, BOOTSTRAP,TAILWIND CSS, Python, Java, C++, python, PHP / LARAVEL, Git, GitHub, SQL , MYSQL, POSTGRESQL , etc.
